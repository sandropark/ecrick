...
public class LibraryDto {
    ...
    public static LibraryDto of(String name, String url, String apiUrl, Integer totalBooks, Integer savedBooks, String contentType) {
        return new LibraryDto(null, name, url, apiUrl, totalBooks, savedBooks, contentType);
    }
