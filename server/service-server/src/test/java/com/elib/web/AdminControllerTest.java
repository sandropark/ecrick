...
class AdminControllerTest {
    ...
    void libraries() throws Exception {
        ...
        // When
        mvc.perform(MockMvcRequestBuilders.get(AdminController.ADMIN_LIBRARIES))
    ...
    void libraryDetail() throws Exception {
        ...
        // When
        mvc.perform(get(AdminController.ADMIN_LIBRARIES + "/" + libraryId))
                .andExpect(status().isOk())
                .andExpect(content().contentTypeCompatibleWith(MediaType.TEXT_HTML))
    ...
    void deleteLibrary() throws Exception {
        ...
        // When
        mvc.perform(post(AdminController.ADMIN_LIBRARIES + "/" + libraryId + "/delete"))
                .andExpect(status().is3xxRedirection())
                .andExpect(view().name("redirect:" + AdminController.ADMIN_LIBRARIES));
    ...
    void crawl() throws Exception {
        ...
        // When
        mvc.perform(post(AdminController.ADMIN_LIBRARIES + "/1/crawl")
                        .param("keyword", "")
                        .param("page", "")
                        .param("sort", "")
                        .param("size", ""))
    ...
    void updateSavedBooks() throws Exception {
        ...
        // When
        mvc.perform(post(AdminController.ADMIN_LIBRARIES + "/" + libraryId + "/saved-update")
                        .param("keyword", "")
                        .param("page", "")
                        .param("sort", "")
                        .param("size", ""))
    ...
    void addForm() throws Exception {
        // When & Then
        mvc.perform(get(AdminController.ADMIN_LIBRARIES + "/form"))
                .andExpect(status().isOk())
                .andExpect(model().attributeExists("library"))
    ...
    void save() throws Exception {
        ...
        // When
        mvc.perform(post(AdminController.ADMIN_LIBRARIES + "/form")
                        .param("name", "서울"))
                .andExpect(status().is3xxRedirection())
                .andExpect(redirectedUrl(AdminController.ADMIN_LIBRARIES));
    ...
    void editForm() throws Exception {
        ...
        // When
        mvc.perform(get(AdminController.ADMIN_LIBRARIES + "/" + libraryId + "/form"))
                .andExpect(status().isOk())
                .andExpect(model().attributeExists("library"))
    ...
    void update() throws Exception {
        ...
        // When
        mvc.perform(post(AdminController.ADMIN_LIBRARIES + "/" + libraryId + "/form"))
                .andExpect(status().is3xxRedirection())
                .andExpect(redirectedUrl(AdminController.ADMIN_LIBRARIES + "/" + libraryId));
