...
public class CrawlerUtil {
    ...
    public static final List<CrawlerParser> parsers = List.of(
//            new KyoboXmlParser(),
//            new KyoboJsonParser(),
//            new Yes24XmlParser(),
//            new Yes24JsonParser(),
...
//            new SeoulEduParser()
    ...
    public static Optional<ResponseDto> getResponseDto(String url, LibraryCrawlerDto libraryDto) {
        try {
            return Optional.of(getParser(libraryDto).parse(ResponseBodyDto.from(requestUrl(url))));
