...
import com.ecrick.crawler.healthcheck.code.HealthCheckClient;
import com.ecrick.crawler.healthcheck.code.JsoupHealthCheckClient;
...
//    @Bean
    ...
    public HealthCheckClient healthCheckClient() {
        return new JsoupHealthCheckClient();
    }
